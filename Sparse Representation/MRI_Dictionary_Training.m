...
TR_IMG_PATH = 'Data/MRI/valid_HR';

dict_size   = 100; %512;          % dictionary size
...
[Xh, Xl] = rnd_smp_patch(TR_IMG_PATH, '*.png', patch_size, nSmp, upscale);
...
dict_path = ['Dictionary/MRI/D_' num2str(dict_size) '_' num2str(lambda) '_' num2str(patch_size) '.mat' ];
