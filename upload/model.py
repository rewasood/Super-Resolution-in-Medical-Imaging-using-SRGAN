...
from utils import Subpixel_anisotropic
from utils import Subpixel_mod
...
def SRGAN_g(t_image, is_train=False, reuse=False):
    ...
    with tf.variable_scope("SRGAN_g", reuse=reuse) as vs:
        ...
        n = Subpixel_anisotropic(n, scale=2)
        #n = Subpixel_mod(n, scale=2)
        #n = SubpixelConv2d(n, scale=2, n_out_channel=None, act=tf.nn.relu, name='pixelshufflerx2/1')
        n = tf.nn.relu(n)

        n = InputLayer(n, name='next_upscale')
        ...
        n = InputLayer(n, name='final_upscale')
